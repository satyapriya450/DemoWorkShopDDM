...
public class TestConfig{
	...
	public static String from = "testmailsmtpdemo@gmail.com";
	public static String password = "kanna@123";
	public static String[] to ={"testmailsmtpdemo@gmail.com","testmailsmtpdemo@gmail.com"};
