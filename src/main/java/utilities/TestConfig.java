...
public class TestConfig{
	...
	public static String from = "prasadkanna546@gmail.com";
	public static String password = "sbukmcxmfvwwmmho";
	public static String[] to ={"prasadkanna546@gmail.com","prasadkanna546@gmail.com"};
